...
-- AddForeignKey
ALTER TABLE "JobModel" ADD CONSTRAINT "JobModel_work_id_fkey" FOREIGN KEY ("work_id") REFERENCES "WorkModel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ProviderWorkJobModel" ADD CONSTRAINT "ProviderWorkJobModel_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "JobModel"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
